...
<div class="container-fluid" id="wrapper">
	<header id="banner" role="banner">
		<div class="languag1">
			<div id="languag">
			<#assign locPortletId = "82_INSTANCE_ABCD" />
			...
			<#assign temp = portletSetup.setValue("languageIds", "es_ES,en_GB") />
			<#assign temp = portletSetup.setValue("advancedConfiguration", "false") />
	...
	<footer id="footer" role="contentinfo">
		<p class="powered-by">
			<@liferay.language key="powered-by" /> <a href="http://www.ebd.csic.es/informatica" rel="external">Servicio de informática de la EBD</a>
		</p>
	</footer>
</div>
