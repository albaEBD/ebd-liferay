...
<div id="navigat" aria-label="#language ("site-pages")" role="menubar">
		...
		<div class="collapse nav-collapse">
			...
			<#list nav_items as nav_item>
				...
				<#if nav_item.hasChildren()>
						<#assign nav_item_attr_has_popup="aria-has_popup='true'" />
				...
				<li class="${nav_item_css_class}" id="layout_${nav_item.getLayoutId()}" ${nav_item_attr_selected} role="presentation">
					<a aria-labelledby="layout_${nav_item.getLayoutId()}" ${nav_item_attr_has_popup} href="${nav_item.getURL()}" ${nav_item.getTarget()} role="menuitem"><span>${nav_item.icon()} ${nav_item.getName()} ${nav_item_caret}</span></a>
...
<script>
Liferay.Data.NAV_LIST_SELECTOR = '#navigat';
</script>